 ...
 * 用户传入消息种类
 */
export type ServerSendWebSocketMessage = z.infer<typeof ServerSendMessageSchema>;
...
export type ServerSendWebsocketMessageType = z.infer<typeof ServerSendWebSocketSchema>;
